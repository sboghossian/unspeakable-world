...
export function MobileMenuDrawer({ groups }: Props) {
  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className={`pointer-events-auto inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-lg border text-base backdrop-blur transition ${
          open
